...
export const MAIN_NAV_ITEMS = [
  { label: "ACCUEIL",  value: ViewState.HOME,             path: ROUTE_MAP[ViewState.HOME],             icon: HomeIcon,        color: "bg-[#0F0F0F]", desc: "Retour à l'accueil" },
  ...
  { label: "LOGEMENT", value: ViewState.SQUAT,            path: ROUTE_MAP[ViewState.SQUAT],            icon: TentIcon,        color: "bg-[#0F0F0F]", desc: "Guide squat et occupations." },
