...
export const MAIN_NAV_ITEMS = [
  ...
  { label: "NEWS",     value: ViewState.NEWS,             path: ROUTE_MAP[ViewState.NEWS],             icon: NewsIcon,        color: "bg-guinea-yellow text-earth-black", desc: "L'actualité du pays et de la diaspora." },
  ...
  { label: "ANNUAIRE", value: ViewState.COMMUNITY,        path: ROUTE_MAP[ViewState.COMMUNITY],        icon: SearchIcon,      color: "bg-guinea-green",                  desc: "Commerces et services." },
