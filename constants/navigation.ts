...
export const MAIN_NAV_ITEMS = [
  ...
  { label: "NEWS", value: ViewState.NEWS, icon: NewsIcon, color: "bg-guinea-red", desc: "Actualités du pays et de la diaspora." },
  ...
  { label: "FESTIVAL", value: ViewState.FESTIVAL, icon: FestivalIcon, color: "bg-guinea-green", desc: "Le festival des sans-papiers." },
