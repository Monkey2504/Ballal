...
export const translations: Record<LanguageCode, Translation> = {
  fr: {
    ...
    legal_intro: "En collaboration avec la Ligue des Droits Humains et le CIRÉ. En cas d'arrestation, le silence est votre meilleure protection.",
    ...
    flash_close: "Fermer",
    click_for_flash: "Cliquez pour le mode urgence",
    legal_flash_btn: "CLIQUEZ ICI EN CAS D'URGENCE POLICE",
    legal_flash_protection: "Ceci est une protection légale.",
    legal_flash_screenshot: "Capture d'écran conseillée",
    legal_strategy_title: "La Stratégie Papiers",
    legal_warning: "Attention aux pièges. Ne confondez jamais ces deux procédures.",
    legal_9bis_title: "9bis (Humanitaire)",
    legal_9bis_desc: "Preuve d'intégration (travail, longue présence). Passeport valide obligatoire.",
    legal_9ter_title: "9ter (Médical)",
    legal_9ter_desc: "Uniquement si risque vital et impossibilité de soins au pays. Très strict.",
    legal_school_title: "L'École : Zone Sanctuaire",
    legal_school_subtitle: "Pas de papiers ? Pas de problème.",
    legal_school_desc: "L'inscription est un droit fondamental, avec ou sans papiers.",
    legal_school_point1: "L'école ne dénonce JAMAIS à la police.",
    legal_school_point2: "La police n'entre pas dans les écoles.",
    legal_school_point3: "L'école est une preuve forte pour le 9bis.",
    legal_home_title: "Domicile = Forteresse",
    legal_home_subtitle: "Inviolabilité du logement",
    legal_home_warrant: "\"AVEZ-VOUS UN MANDAT ?\"",
    legal_home_police: "La police ne peut jamais entrer sans mandat d'un Juge.",
    legal_home_oqt: "Un ordre de quitter le territoire (OQT) ne suffit pas pour entrer.",
    legal_home_action: "N'ouvrez pas. Ne parlez pas. Demandez le mandat à travers la porte.",
    health_title: "Santé & Urgence",
    health_desc: "Même sans papiers, vous avez droit aux soins médicaux (AMU).",
    health_steps_title: "Procédure CPAS :",
    health_step1: "Allez au CPAS de votre commune.",
    health_step2: "Demandez l'Aide Médicale Urgente.",
    health_step3: "Vérification de l'indigence.",
    health_step4: "Le CPAS ne vous dénonce pas.",
    allies_title: "Vos Alliés Stratégiques",
    allies_desc: "Ne faites jamais confiance à la rumeur. Faites confiance aux juristes.",
    legal_ally_cire: "Coordination politique des sans-papiers.",
    legal_ally_adde: "L'arme du droit. Fiches juridiques.",
    legal_ally_ldh: "Contre les violences policières.",
  ...
  en: {
    ...
    legal_intro: "In collaboration with the Human Rights League and CIRÉ. In case of arrest, silence is your best protection.",
  ...
  nl: {
    ...
    legal_intro: "In samenwerking met de Liga voor Mensenrechten en CIRÉ. In geval van arrestatie is zwijgen uw beste bescherming.",
  ...
  es: {
    ...
    legal_intro: "En colaboración con la Liga de Derechos Humanos y CIRÉ. En caso de arresto, el silencio es su mejor protección.",
  ...
  ar: {
    ...
    legal_intro: "بالتعاون مع رابطة حقوق الإنسان و CIRÉ. في حالة الاعتقال، الصمت هو أفضل حماية لك.",
  ...
  pe: {
    ...
    legal_intro: "Gondidal e Ligue des Droits Humains e CIRÉ. Si a nanngaama, deƴƴugol no ɓuri.",
  ...
  ma: {
    ...
    legal_intro: "An ni Ligue des Droits Humains ni CIRÉ. Ni i minèna, makun.",
  ...
  su: {
    ...
    legal_intro: "Muxu nun Ligue des Droits Humains nun CIRÉ. Kha i suxu, i dundhu.",
