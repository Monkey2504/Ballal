...
const fr: Translation = {
  ...
  hero_asbl: "Association de sans-papiers — par et pour la communauté",
  btn_assist: "Demander de l'aide",
  btn_donate: "Soutenir la cause",
  team_title: "Conseil d'Administration",
  team_subtitle: "Certains ont été sans-papiers. Tous connaissent le chemin. C'est ça, notre force.",
  members_title: "La communauté qui construit",
  team_collective_strength: "Ballal est une association construite par le bas — du terrain à la culture. Chaque membre qui nous rejoint renforce un réseau de solidarité bâti par ceux qui l'ont vécu.",
