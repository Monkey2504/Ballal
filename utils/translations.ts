...
const fr: Translation = {
    ...
    hist_title: "Histoire des Noirs de Belgique : L'Épopée Guinéenne",
    hist_subtitle: "Quatre grandes vagues migratoires, une seule communauté résiliente. De l'indépendance de 1958 à l'affirmation citoyenne d'aujourd'hui.",
    ...
    hist_1958_title: "1958 : L'Étincelle de l'Indépendance",
    hist_1958_desc: "Le 'Non' de Sékou Touré. Le 28 septembre, la Guinée devient le phare de la dignité noire en Afrique francophone. C'est le point de départ d'une relation complexe avec l'Europe, marquée par la fierté nationale.",
    hist_1960_title: "Vague 1 (60s-80s) : L'Élite Intellectuelle",
    ...
    hist_2024_desc: "Une jeunesse courageuse, souvent mineure (MENA), traversant la Méditerranée pour fuir la précarité. Ils arrivent avec une résilience inouïe, cherchant formation et dignité malgré un parcours migratoire traumatisant.",
...
const en: Translation = {
    ...
    hist_1958_desc: "Sékou Touré's 'No'. On September 28, Guinea became the beacon of black dignity in Francophone Africa. This was the starting point of a complex relationship with Europe, marked by national pride.",
    hist_1960_title: "Wave 1 (60s-80s): The Intellectual Elite",
    hist_1960_desc: "Arrival of scholarship students and diplomats. A chosen, intellectual immigration, coming to train in Belgian universities (ULB, UCL, Liège). This pioneering generation laid the academic foundations of the diaspora.",
    hist_1990_year: "90s",
    hist_1990_title: "Wave 2 (90s): Political Exile",
    hist_1990_desc: "Instability in Conakry and the end of the First Republic pushed opponents, activists, and families to flee repression. Belgium became a land of political asylum for those who refused silence.",
    hist_2000_title: "Wave 3 (2000s): Rooting & Families",
    hist_2000_desc: "Period of regularizations (Operation 2000 and 2009) and family reunification. The community became more feminine, children were born here. It is the lasting anchorage in neighborhoods like Matonge or in Liège.",
    hist_2024_title: "Wave 4 (2010-2024): The 'Route' Generation",
    hist_2024_desc: "Courageous youth, often minors (MENA), crossing the Mediterranean to flee precariousness. They arrive with incredible resilience, seeking training and dignity despite a traumatic migratory journey."
};
...
const nl: Translation = {
    ...
    hist_1958_desc: "De 'Nee' van Sékou Touré. Op 28 september werd Guinee het baken van zwarte waardigheid in Franstalig Afrika. Dit was het startpunt van een complexe relatie met Europa, gekenmerkt door nationale trots.",
    hist_1960_title: "Golf 1 (60s-80s): De Intellectuele Elite",
    hist_1960_desc: "Aankomst van beursstudenten en diplomaten. Een gekozen, intellectuele immigratie, gekomen om zich te vormen aan Belgische universiteiten (VUB, KUL, Luik). Deze pioniersgeneratie legde de academische basis van de diaspora.",
    hist_1990_year: "Jaren 90",
    hist_1990_title: "Golf 2 (90s): Politieke Ballingschap",
    hist_1990_desc: "Instabiliteit in Conakry en het einde van de Eerste Republiek dwongen tegenstanders, activisten en families om de repressie te ontvluchten. België werd een land van politiek asiel voor degenen die weigerden te zwijgen.",
    hist_2000_title: "Golf 3 (2000s): Worteling & Gezinnen",
    hist_2000_desc: "Periode van regularisaties (Operatie 2000 en 2009) en gezinshereniging. De gemeenschap vervrouwelijkte, kinderen werden hier geboren. Het is de duurzame verankering in wijken zoals Matonge of in Luik.",
    hist_2024_title: "Golf 4 (2010-2024): De 'Route' Generatie",
