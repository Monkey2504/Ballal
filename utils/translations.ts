...
export const translations: Record<LanguageCode, Translation> = {
  ...
  en: {
    ...
    news_section_title: "News from the Country",
  ...
  es: {
    ...
    news_section_subtitle: "Noticias verificadas desde Conakry",
    ...
    team_title: "Consejo de Administración",
  ...
  pe: { // Pular (Peul)
    ...
    news_section_subtitle: "Kibaruuji ƴeewtaɗi ummoraade Konaakiri",
    read_article: "Jannge fimen",
    verified_sources: "Asal laaɓuɗi:",
  ...
  ma: { // Malinké
    ...
    news_section_title: "Jamana Kibaru",
    news_section_subtitle: "Kibaru kɔlɔsilenw ka bɔ Conakry",
    read_article: "Kalan",
    verified_sources: "Kibaru source:",
  ...
  su: { // Soussou
    ...
    news_section_title: "Sogé Xibaru",
    news_section_subtitle: "Kibanyi yama tixi naxan kelixi Conakry",
    read_article: "Karan",
