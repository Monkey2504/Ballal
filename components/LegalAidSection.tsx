      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12">
        ...
        >
            <div className="bg-white rounded-xl shadow-2xl overflow-hidden border-4 border-[#CE1126] relative max-w-2xl mx-auto group">
                ...
                <div className="bg-gray-900 text-white p-3 text-center text-xs font-mono flex justify-between px-6">
                    <span>{t.legal_flash_protection}</span>
                    <span className="flex items-center"><Camera className="h-3 w-3 mr-1" aria-hidden="true"/> {t.legal_flash_screenshot}</span>
                </div>
            </div>
        </div>
            ...
            <div className="bg-white rounded-xl shadow-md border-l-8 border-blue-600 overflow-hidden hover:shadow-lg transition-all">
                <div className="p-6">
                    <div className="flex items-center mb-6">
                        ...
                        <h3 className="text-2xl font-black text-gray-900">{t.legal_strategy_title}</h3>
                    </div>
                ...
                <div className="p-6">
                    ...
                    <div className="space-y-4">
                        <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                            <p className="font-bold text-gray-900 text-lg mb-2">{t.legal_school_subtitle}</p>
                        ...
                        <ul className="space-y-3 text-gray-700 font-medium">
                            ...
                            <li className="flex items-start">
                                ...
                                <span className="text-sm">{t.legal_school_point3}</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="p-6">
                    <div className="flex items-center mb-6">
                        ...
                        <div className="flex flex-col">
                            <h3 className="text-2xl font-black text-gray-900">{t.legal_home_title}</h3>
                            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">{t.legal_home_subtitle}</span>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="p-5 bg-slate-100 rounded-lg border-2 border-slate-200 relative overflow-hidden">
                            ...
                            <p className="font-black text-slate-900 text-xl mb-2">{t.legal_home_warrant}</p>
                ...
                <div className="p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-green-50 p-4 rounded-lg border border-green-100">
                            <h4 className="font-bold text-green-900 mb-2">{t.health_steps_title}</h4>
                            <ol className="list-decimal list-inside text-sm text-green-800 space-y-2">
                                <li>{t.health_step1}</li>
                                <li>{t.health_step2}</li>
                                <li>{t.health_step3}</li>
                                <li><span className="font-bold">{t.health_step4}</span></li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <div className="bg-slate-800 rounded-xl p-8 text-slate-200 relative overflow-hidden">
            ...
            <div className="text-center mb-8 relative z-10">
                <h3 className="text-2xl font-bold text-white mb-2">{t.allies_title}</h3>
                <p className="text-slate-400">{t.allies_desc}</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 relative z-10">
                <a href="https://www.cire.be/" target="_blank" rel="noreferrer" className="bg-slate-700/80 p-5 rounded hover:bg-red-900 transition-colors border border-slate-600 hover:border-red-500 group text-center focus:outline-none focus:ring-2 focus:ring-white">
                    ...
                    <p className="text-xs text-slate-400 group-hover:text-white">{t.legal_ally_cire}</p>
                </a>
                <a href="https://www.adde.be/" target="_blank" rel="noreferrer" className="bg-slate-700/80 p-5 rounded hover:bg-blue-900 transition-colors border border-slate-600 hover:border-blue-500 group text-center focus:outline-none focus:ring-2 focus:ring-white">
                    ...
                    <p className="text-xs text-slate-400 group-hover:text-white">{t.legal_ally_adde}</p>
                </a>
                <a href="https://www.liguedh.be/" target="_blank" rel="noreferrer" className="bg-slate-700/80 p-5 rounded hover:bg-[#FCD116] hover:text-black transition-colors border border-slate-600 hover:border-white group text-center focus:outline-none focus:ring-2 focus:ring-white">
                    ...
                    <p className="text-xs text-slate-400 group-hover:text-black">{t.legal_ally_ldh}</p>
                </a>
            </div>
        </div>
