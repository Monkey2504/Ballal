...
const NewsSection: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {/* NEWS GRID */}
      {loading ? (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6" aria-label="Chargement des actualités">
           {[1, 2, 3].map(i => (
                ...
                >
                    ...
                    <div className="pt-4 border-t border-gray-50 flex items-center justify-between text-xs text-gray-400">
                        ...
                        <div className="flex items-center font-bold text-gray-300 group-hover:text-[#CE1126] transition-colors">
                            Lire l'article <ArrowRight className="h-3 w-3 ml-1" aria-hidden="true" />
                        </div>
                    </div>
                </article>
            ))}
      ...
      {sources.length > 0 && (
        <div className="mt-8 pt-6 border-t border-gray-200">
            <p className="text-xs text-gray-400 mb-2 flex items-center"><ExternalLink className="h-3 w-3 mr-1" aria-hidden="true"/> Sources vérifiées :</p>
